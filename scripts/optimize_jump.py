...
def optimize_single_video(
    report: dict,
    body_mass_kg: float = ATHLETE_A_MASS,
    athlete_height_m: float = ATHLETE_A_HEIGHT,
...
def main():
    ...
    parser.add_argument(
        "--mass", type=float, default=ATHLETE_A_MASS,
        help="Athlete mass in kg",
    )
    parser.add_argument(
        "--height", type=float, default=ATHLETE_A_HEIGHT,
