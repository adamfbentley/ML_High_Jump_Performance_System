...
Usage:
    ...
    python scripts/analyze_jump_video.py path/to/jump.mp4 --mass 67 --height 1.78
...
def parse_bar_height(filename: str) -> float | None:
    """Extract bar height from filename like '06_03_24_one_1.78.mp4' → 1.78."""
    import re
    # Match decimal like _1.78 or _1.88 before the extension
