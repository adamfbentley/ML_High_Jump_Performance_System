...
champion high jumper and biomedical researcher at GMRI, and Adam Bentley. The
...
training-relevant changes. This is not a finished consumer app yet. Current
work is focused on validation, calibration, and finding the filming setup needed
for scientifically defensible results.

## Current Status

This is an active research codebase, not a polished coaching product. The core
