...
Athlete A's priority takeoff metrics:
...
class TakeoffMetrics:
    ...
    # ── Body alignment (Athlete A priority) ─────────────────────────────────
    ...
    # ── Foot-to-ground angle (Athlete A priority) ────────────────────────────
    ...
    # ── Free-knee drive (Athlete A priority) ────────────────────────────────
...
def compute_body_alignment_deviation(
    ...
    (the ideal Athlete A describes as "body in straight line at takeoff").
...
def compute_arm_drive_metrics(
    ...
    Arm-drive speed is the magnitude of wrist velocity.  Athlete A identified
...
def compute_free_knee_drive_metrics(
    ...
    Athlete A identified "speed and timing of knee (non-takeoff leg) drive" as a
    priority metric.
