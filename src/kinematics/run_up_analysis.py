...
Imogen's priority metrics (from athlete brief):
...
def compute_acceleration_rhythm(
    ...
    Gives the per-stride 'acceleration rhythm' metric Imogen identified:
